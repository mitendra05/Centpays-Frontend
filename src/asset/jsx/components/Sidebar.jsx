              ...
              <div className="sidebar-middle">
                <ul>
                  ...
                  <li className="menuitem-disable">
                    <div
                      className={`menu-item ${
                        menuOpen.masterSetting ? "sidebaractive" : ""
                      }`}
                    >
                  ...
                  <li className="menuitem-disable">
                    <div
                      className={`menu-item ${
                        currentPath === "/paymentgateway" ? "sidebaractive" : ""
                      }`}
                    >
                  ...
                  <li>
                    <div
                      className={`menu-item ${
                        menuOpen.finance ? "sidebaractive" : ""
                      }`}
                    >
                      <TransactionReport className="icon menu-item-icon-color" />
                      <div
              ...
              <div className="sidebar-middle">
                <ul>
                  ...
                  <li>
                    <div
                      className={`menu-item ${
                        menuOpen.myprofile ? "sidebaractive" : ""
                      }`}
                    >
                      <ManageMerchant className="icon menu-item-icon-color" />
                      <div
                  ...
                  <li>
                    <div
                      className={`menu-item ${
                        menuOpen.testApi ? "sidebaractive" : ""
                      }`}
                    >
