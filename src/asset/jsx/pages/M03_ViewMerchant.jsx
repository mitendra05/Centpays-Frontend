		  ...
		  <div className="btn-container">
			{overviewInfo ? (
			  <button className="btn-primary btn3">
				<div className="Info-btn"><PendingUserIcon className=" white-icon" width="20" height="20" />  
				<p>Overview</p>
				</div>
			  </button>
			) : (
			...
			{ratesInfo ? (
			  <button className="btn-primary btn3">
			   <div className="Info-btn"><MerchantRates className=" white-icon" />
				<p>Rates</p>
				</div>
			  </button>
			) : (
        ...
        >
          <div className="view-merchant-container">
            <div className="row-cards left-section">
                <LeftArrow className="icon2" onClick={this.handleBackButtonClick}/>
